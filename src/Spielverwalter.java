...
/**
 Ein Spielerverwalter verwaltet die Spieler und die Karten.
 Ein Spielerverwalter verwaltet zudem der aktuellen Spieler und die aktuelle Punktezahl.
 */
class Spielerverwalter {
   ...
   *  @param istTutto : überprüft ob es ein Tutto ist.
   */
   ...
   *  @param anzNeuAngewaehlt : anzahl neu angewählten Würfeln.
   *  @return: T: wenn aktuelle Spielerpunktzahl grösser als die Spielerpunktzahl F: sonst
   */
  boolean actSpielerHatErreicht(int punkte) {
    if (actSpieler.spielerPunkte >= punkte) return true;
    return false;
  }
  /**
  ...
  void berechneActPunkte(int augenZahl, int anzNeuAngewaehlt) {
    ...
    case 3: 
      ...
      if (augenZahl==1) addActPunkte(900);
      break;
    case 4: //???
      addActPunkte(100 * augenZahl);
      if (augenZahl==1) addActPunkte(1000);
      if (augenZahl==5) addActPunkte(50);
      break;
    case 5: //???
      addActPunkte(100 * augenZahl);
      if (augenZahl==1) addActPunkte(1100);
      if (augenZahl==5) addActPunkte(100);
      break;
    case 6: 
      addActPunkte(100 * augenZahl);
      if (augenZahl==1) addActPunkte(900);
      ...
      break;
    default:
      if (augenZahl==1) addActPunkte(100*anzNeuAngewaehlt);
      if (augenZahl==5) addActPunkte(50*anzNeuAngewaehlt);
      break;
    }
  }
}